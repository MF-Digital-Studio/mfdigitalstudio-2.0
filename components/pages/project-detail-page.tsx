        ...
        <div className="flex flex-col items-center gap-1.5">
            <div className="relative h-16 w-16">
                <svg viewBox="0 0 64 64" className="h-16 w-16" aria-hidden="true">
                    <circle cx="32" cy="32" r={radius} fill="none" strokeWidth="4" className="stroke-black/10" />
                    <motion.circle
                        cx="32"
                        cy="32"
                        r={radius}
        ...
        <main className="min-h-screen bg-white text-black">
            <motion.div layoutId={project.slug} className="min-h-screen bg-white">
                <section className="relative mx-auto w-full max-w-384 px-6 pb-24 pt-12 md:px-10 md:pt-16">
                    <Link
                        href="/projeler"
                        className="inline-flex pt-5 text-lg uppercase tracking-[0.16em] text-black/70 transition hover:text-black"
                    >
                        ← TÜM PROJELER
                    </Link>
                    ...
                    <div className="mt-8 max-w-6xl">
                        ...
                        <motion.h1 className={`${syne.className} text-2xl font-extrabold uppercase leading-[0.9] tracking-[-0.03em] sm:text-4xl md:text-5xl lg:text-6xl`}>
                            {project.title}
                        </motion.h1>
                                ...
                                {[
                                    ...
                                    >
                                        <div className="w-full max-w-95 overflow-hidden rounded-3xl border border-black/10 bg-neutral-100 shadow-sm lg:max-w-180">
                                            <img src={src} alt={`${project.title} — ${label}`} className="w-full" />
                                        </div>
