                    ...
                    <section className="mb-10">
                        ...
                        <ul className="list-none space-y-3 text-base leading-8 text-black/80">
                            <li className="flex items-center gap-2">
                                ...
                                <Link href="/gizlilik-politikasi" className="font-semibold underline underline-offset-4">
                                    Gizlilik Politikası
                                </Link>
                            </li>
                            <li className="flex items-center gap-2">
                                <span className="block h-1.5 w-1.5 shrink-0 rounded-full bg-black/40" />
                                <Link href="/kullanim-sartlari" className="font-semibold underline underline-offset-4">
                                    Kullanım Şartları
                                </Link>
                            </li>
                        </ul>
